...
export const GRAPHICS = {
    ...
    DEGREES_TO_RADIANS_FACTOR: 0.017453292519943295,
...
export const WORLD_GEN = {
    ...
    // Moon rendering constants
    MOON_CRATER_BASE_COUNT: 3,
    MOON_CRATER_RANDOM_COUNT: 8,
    MOON_CRATER_DISTANCE_MAX: 0.7,
    MOON_CRATER_SIZE_MIN: 0.05,
    MOON_CRATER_SIZE_MAX: 0.15,
    MOON_CRATER_RIM_RATIO: 0.8,
    MOON_CRATER_DARKEN_FACTOR: 0.4,
    MOON_CRATER_LIGHTEN_FACTOR: 0.3,
    MOON_MARIA_MIN_COUNT: 2,
    MOON_MARIA_MAX_COUNT: 3,
    MOON_MARIA_DISTANCE_MAX: 0.5,
    MOON_MARIA_SIZE_MIN: 0.1,
    MOON_MARIA_SIZE_MAX: 0.25,
    MOON_MARIA_DARKEN_FACTOR: 0.6,
    ...
    MIN_WORMHOLES: 0,
    MAX_WORMHOLES: 2,
    MIN_WORMHOLE_DISTANCE: 500,
    MAX_WORMHOLE_DISTANCE: 1200,
    MIN_WORMHOLE_SIZE: 40,
    MAX_WORMHOLE_SIZE: 80,
    WORMHOLE_SPAWN_PROBABILITY: 0.3,
    WORMHOLE_INSTABILITY_MIN: 0.1,
    WORMHOLE_INSTABILITY_MAX: 0.8,
    WORMHOLE_INACTIVE_INSTABILITY_THRESHOLD: 0.8,
    WORMHOLE_NAME_LETTER_BASE: 65, // ASCII 'A'
    WORMHOLE_NAME_LETTER_COUNT: 26,
    WORMHOLE_NAME_NUMBER_MAX: 99,
    WORMHOLE_ENERGY_FLUCTUATION_BASE: 25,
    WORMHOLE_ENERGY_FLUCTUATION_RANGE: 50,
    WORMHOLE_TEMPORAL_DISTORTION_MAX: 0.3,
