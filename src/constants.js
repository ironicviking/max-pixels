...
export const GRAPHICS = {
    ...
    TRADE_ROUTE_LINE_WIDTH: 2,
    TRADE_ROUTE_DASH_LENGTH: 8,
    TRADE_ROUTE_DASH_GAP: 4,
    TRADE_ROUTE_ACTIVE_COLOR: '#00ff88',
    TRADE_ROUTE_INACTIVE_COLOR: '#666666',
    TRADE_ROUTE_PROFIT_COLOR: '#ffff00',
    TRADE_ROUTE_LOSS_COLOR: '#ff4444',
    TRADE_ROUTE_ANIMATION_DURATION: 3,
    TRADE_ROUTE_PULSE_OPACITY_MIN: 0.3,
    TRADE_ROUTE_PULSE_OPACITY_MAX: 0.8,
    TRADE_ROUTE_ARROW_SIZE: 8,
    TRADE_ROUTE_ARROW_SPACING: 100,
    TRADE_ROUTE_ARROW_STAGGER_DELAY: 0.2,
...
export const WORLD_GEN = {
    ...
    COMET_NUCLEUS_RATIO: 1.0,
    COMET_COMA_RATIO: 3.0,
    COMET_TAIL_LENGTH_MIN: 5.0,
    COMET_TAIL_LENGTH_MAX: 12.0,
    COMET_DUST_TAIL_WIDTH_RATIO: 0.8,
    COMET_ION_TAIL_WIDTH_RATIO: 0.4,
    COMET_NUCLEUS_OPACITY: 0.9,
    COMET_COMA_OPACITY: 0.3,
    COMET_DUST_TAIL_OPACITY: 0.2,
    COMET_ION_TAIL_OPACITY: 0.4,
    COMET_TAIL_PARTICLES: 8,
    COMET_PARTICLE_SIZE_MIN: 0.5,
    COMET_PARTICLE_SIZE_MAX: 2.0,
    COMET_PARTICLE_OPACITY: 0.6,
    COMET_ANIMATION_DURATION: '4s',
    COMET_ION_TAIL_OFFSET_RATIO: 2.2,
    COMET_PARTICLE_DISTANCE_MIN: 0.3,
    COMET_PARTICLE_DISTANCE_RANGE: 0.7,
    COMET_PARTICLE_SPREAD_CENTER: 0.5,
    COMET_PARTICLE_COLOR_THRESHOLD: 0.5,
    COMET_COMA_ANIMATION_OPACITY_FACTOR: 0.7,
    
    // Black hole rendering constants
    BLACK_HOLE_DEFAULT_SIZE: 50,
    BLACK_HOLE_EVENT_HORIZON_RATIO: 1.0,
    BLACK_HOLE_ACCRETION_DISK_INNER_RATIO: 2.5,
    BLACK_HOLE_ACCRETION_DISK_OUTER_RATIO: 4.5,
    BLACK_HOLE_PHOTON_SPHERE_RATIO: 1.5,
    BLACK_HOLE_LENSING_RING_RATIO: 6.0,
    BLACK_HOLE_JET_LENGTH_RATIO: 8.0,
    BLACK_HOLE_JET_WIDTH_RATIO: 0.8,
    BLACK_HOLE_DEBRIS_COUNT: 12,
    BLACK_HOLE_DEBRIS_ORBIT_MIN: 3.0,
    BLACK_HOLE_DEBRIS_ORBIT_MAX: 5.5,
    BLACK_HOLE_DEBRIS_SIZE_MIN: 1.0,
    BLACK_HOLE_DEBRIS_SIZE_MAX: 3.0,
    BLACK_HOLE_EVENT_HORIZON_OPACITY: 1.0,
    BLACK_HOLE_ACCRETION_DISK_OPACITY: 0.8,
    BLACK_HOLE_PHOTON_SPHERE_OPACITY: 0.4,
    BLACK_HOLE_LENSING_RING_OPACITY: 0.2,
    BLACK_HOLE_JET_OPACITY: 0.7,
    BLACK_HOLE_DEBRIS_OPACITY: 0.9,
    BLACK_HOLE_ANIMATION_DURATION: '8s',
    BLACK_HOLE_JET_ANIMATION_DURATION: '6s',
    BLACK_HOLE_DEBRIS_ANIMATION_DURATION: '12s',
    
    // Pulsar rendering constants
    PULSAR_DEFAULT_SIZE: 25,
    PULSAR_CORE_RATIO: 1.0,
    PULSAR_MAGNETOSPHERE_RATIO: 2.8,
    PULSAR_BEAM_LENGTH_RATIO: 12.0,
    PULSAR_BEAM_WIDTH_RATIO: 0.4,
    PULSAR_BEAM_ANGLE: 30, // degrees from pole
    PULSAR_CORE_OPACITY: 0.9,
    PULSAR_MAGNETOSPHERE_OPACITY: 0.3,
    PULSAR_BEAM_OPACITY: 0.8,
    PULSAR_PULSE_DURATION: '2s',
    PULSAR_ROTATION_DURATION: '1.5s',
    PULSAR_FIELD_LINE_COUNT: 6,
    PULSAR_FIELD_LINE_OPACITY: 0.2,
    PULSAR_BEAM_COUNT: 2, // Dual beams from magnetic poles
    PULSAR_FIELD_RADIUS_RATIO: 0.9,
    PULSAR_FIELD_RX_RATIO: 0.3,
    PULSAR_BEAM_POLE_ANGLE: 180, // degrees between magnetic poles
    PULSAR_BEAM_INTENSITY_GRADIENTS: {
        CORE: 0.9,
        MID: 0.7,
        OUTER: 0.4,
        FADE: 0.1
    },
    PULSAR_CORE_PULSE_MIN: 0.8,
    PULSAR_ANIMATION_OFFSET: 0.1, // seconds
    PULSAR_MAGNETOSPHERE_GRADIENTS: {
        INNER: 0.4,
        MID: 0.2,
        OUTER: 0.05
    },
    PULSAR_TYPE_SCALES: {
        MILLISECOND: { SIZE: 0.8, FIELD: 1.2, BEAM: 1.4 },
        NORMAL: { SIZE: 1.0, FIELD: 1.0, BEAM: 1.0 },
        MAGNETAR: { SIZE: 1.2, FIELD: 2.0, BEAM: 1.8 }
    },
    PULSAR_ROTATION_SPEEDS: {
        SLOW: '8s',
        FAST: '0.8s',
        MILLISECOND: '0.03s'
    },
